...
package com.example.demorabbitmq.amqp;
...
public class AmqpListener implements DeliverCallback {
        private final String expectedMessage;
        private final Map<String, String> expectedHeaders;
        private final CountDownLatch latch = new CountDownLatch(1);

        public AmqpListener(String expectedMessage, Map<String, String> expectedHeaders) {
